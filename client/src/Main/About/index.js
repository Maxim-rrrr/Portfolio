                        ...
                        <div className="hero__text-box">
                            ...
                            <div className="hero__position-box">
                                ...
                                <div className="hero__text-position">
                                    ...
                                    <br /><br />
                                    Мне 20 лет, но я успел уже получить аттестацию преподавателя 
                                    Лицея Академии Яндекса по языку программирования Python и сейчас руковожу площадкой, 
                                    на базе своего университета. 
                                    <br /><br />
                                    Заинтересован во всем спектре разработки и работает над амбициозными проектами с позитивными людьми.
                                    <br />
                                    <br />
